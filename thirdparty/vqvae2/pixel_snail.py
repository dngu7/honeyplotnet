# Copyright (c) Xi Chen
# 
# This source code is licensed under the MIT license found in this folder and at
# https://github.com/rosinality/vq-vae-2-pytorch/blob/master/LICENSE.
...
class PixelSNAIL(nn.Module):
    ...
    def forward(self, x, condition=None, cache=None):
        ...
        #print(x.shape, self.n_class, self.background)
        #print(F.one_hot(x.to(torch.int64), self.n_class).shape)
        x = (
        ...
        #print("self.background", self.background.shape, height)
        ...
        if condition is not None:
            if 'condition' in cache:
                ...
                condition = F.interpolate(condition, size=out.shape[-2:])
